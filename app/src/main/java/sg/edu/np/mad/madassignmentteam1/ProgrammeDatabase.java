...
public class ProgrammeDatabase {
    ...
    public ProgrammeDatabase() {
        ...
        String[][] programDetails = {
                {"Culinary Delights Tour", "Embark on a guided tour through local markets, taste authentic dishes, and learn about the culinary traditions of the region.", "Food & Dining"},
                {"Cooking Class with a Local Chef", "Join a hands-on cooking class led by a skilled local chef, where you'll learn to prepare traditional recipes using fresh local ingredients.", "Food & Dining"},
                {"Mountain Hiking Expedition", "Embark on a thrilling hiking adventure, trekking through scenic trails, and reaching breathtaking viewpoints in the mountains.", "Adventure & Outdoor Activities"},
...
// Iterate through the program details array and create Programme objects
        for (String[] details : programDetails) {
            ...
            Programme programme = new Programme(title, description, category);
